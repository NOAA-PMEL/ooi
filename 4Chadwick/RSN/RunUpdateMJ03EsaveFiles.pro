;
; This is a setup file: RunUpdateMJ03EsaveFiles.pro
; Updating the following IDL save files:
; 3DayMJ03[E/F]-[HEAT/IRIS/LILY/NANO].idl and
;     MJ03[E/F]-[HEAT/IRIS/LILY/NANO].idl
...
;
;
EXIT  ; RunUpdateMJ03EsaveFiles.pro

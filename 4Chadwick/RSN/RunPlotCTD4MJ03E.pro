;
; File: RunPlotCTD4MJ03E.pro
;
; Display the CTD data: {Density, Salinity & Temperature} near the station: MJ03E.
;
...
; P = PLOT( CTD_TIME   , CTD_TEMP   , 'r', BUFFER=B, DIMENSION=[800, 256],  $
  P = PLOT( CTD_TIME[I], CTD_TEMP[I], 'r', BUFFER=B, DIMENSION=[800, 256],  $
            TITLE='MJ03E CTD Temperature data, Start to Present.',          $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',     XMINOR=11,            $
           XTITLE=T, YTITLE='$Temperature in ^{o}C$', XSTYLE=1 )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDTempAll.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDTempAll.png is created.'
;
...
; P = PLOT( CTD_TIME   , DENSITY   , 'b', BUFFER=B, DIMENSION=[800, 256],     $
  P = PLOT( CTD_TIME[I], DENSITY[I], 'b', BUFFER=B, DIMENSION=[800, 256],     $
            TITLE='MJ03E CTD Density data, Start to Present.',                $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',  XMINOR=11, YRANGE=[MN,MX], $
           XTITLE=T, YTITLE='$Density: kg/m^{3}$', XSTYLE=1 )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDDensAll.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDDensAll.png is created.'
;
...
; P = PLOT( CTD_TIME   , SALINITY  , 'g', BUFFER=B, DIMENSION=[800, 256],     $
  P = PLOT( CTD_TIME[I], SALINITY[I],'g', BUFFER=B, DIMENSION=[800, 256],     $
            TITLE='MJ03E CTD Salinity data, Start to Present.',               $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))', XMINOR=11, YRANGE=[MN,MX],  $
           XTITLE=T, YTITLE='Salinity: ppt',      XSTYLE=1 )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDSalAll.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDSalAll.png is created.'
;
...
; P = PLOT( CTD_TIME[K:N], CTD_TEMP[K:N], 'r',    DIMENSION=[800, 256],   $
  P = PLOT( CTD_TIME[ I ], CTD_TEMP[ I ], 'r',    DIMENSION=[800, 256],   $
            TITLE='MJ03E CTD Temperature data, last 6 months', BUFFER=B,  $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',     XTICKVALUES=M,      $
           XTITLE=T, YTITLE='$Temperature in ^{o}C$', XSTYLE=1, XMINOR=29 )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDTemp6mo.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDTemp6mo.png is created.'
;
...
; P = PLOT( CTD_TIME[K:N],     DENSITY[K:N], 'b', DIMENSION=[800, 256],        $
  P = PLOT( CTD_TIME[ I ],     DENSITY[ I ], 'b', DIMENSION=[800, 256],        $
            TITLE='MJ03E CTD Density data, last 6 months', BUFFER=B,           $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',  XMINOR=29, YRANGE=[MN,MX],  $
           XTITLE=T, YTITLE='$Density: kg/m^{3}$', XTICKVALUES=M, XSTYLE=1     )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDDens6mo.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDDens6mo.png is created.'
;
...
; P = PLOT( CTD_TIME[K:N],     SALINITY[K:N],'g', DIMENSION=[800, 256],       $
  P = PLOT( CTD_TIME[ I ],     SALINITY[ I ],'g', DIMENSION=[800, 256],       $
            TITLE='MJ03E CTD Salinity data, last 6 months', BUFFER=B,         $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))', XMINOR=29, YRANGE=[MN,MX],  $
           XTITLE=T, YTITLE='Salinity: ppt', XTICKVALUES=M,  XSTYLE=1          )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDSal6mo.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDSal6mo.png is created.'
;
;
...
;
  PRINT, SYSTIME() + ' Finish running of RunPlotCTD4MJ03E.pro.'
;
; End of File: RunPlotCTD4MJ03E.pro

...
;
  ...
  PLOT_LILY_TXYT, 'MJ03F/MJ03F-LILY.idl',[ 0,1],  $ ;  PLot All Data only.
                   SHOW_PLOT=0,UPDATE_PLOTS=1  ; December 4th, 2018
  PLOT_LILY_TXYT, 'MJ03F/MJ03F-LILY.idl',[ 0,0,JULDAY(4,25,2015,0,0,0)], $  ; Plot only Data since 4/25/2015
                   SHOW_PLOT=0,UPDATE_PLOTS=1  ; December 4th, 2018
; PLOT_LILY_TXYT, 'MJ03F/MJ03F-LILY.idl',[ 0,1,JULDAY(4,25,2015,0,0,0)], $
;                  SHOW_PLOT=0,UPDATE_PLOTS=1  ; April 17th, 2018
  PRINT, SYSTIME() + ' Plotting the Resultant Magnitudes and Directions...'
  PLOT_LILY_RTMD, 'MJ03F/MJ03F-LILY.idl',[ 0,1],  $ ;  PLot All Data only.
                   SHOW_PLOT=0,UPDATE_PLOTS=1  ; December 4th, 2018
  PLOT_LILY_RTMD, 'MJ03F/MJ03F-LILY.idl',[ 0,0,JULDAY(4,25,2015,0,0,0)], $  ; Plot only Data since 4/25/2015
                   SHOW_PLOT=0,UPDATE_PLOTS=1  ; December 4th, 2018
; PLOT_LILY_RTMD, 'MJ03F/MJ03F-LILY.idl',[ 0,1,JULDAY(4,25,2015,0,0,0)], $
;                  SHOW_PLOT=0,UPDATE_PLOTS=1  ; April 17th, 2018
; PRINT, SYSTIME() + ' Plotting DATA IN MJ03F-LILY.idl'

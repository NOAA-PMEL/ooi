;
; This is a setup file: RunPlotMJ03E-LILY.pro
; for plotting the the last 7-Day, All and data since April 25th, 2015
; fo the data in MJ03E-LILY.idl
...
;
  ...
  PLOT_LILY_TXYT, 'MJ03E/MJ03E-LILY.idl',[ 0,1,JULDAY(4,25,2015,0,0,0)], $
                   SHOW_PLOT=0,UPDATE_PLOTS=1  ; April 17th, 2018
  PRINT, SYSTIME() + ' Plotting the Resultant Magnitudes and Directions...'
  PLOT_LILY_RTMD, 'MJ03E/MJ03E-LILY.idl',[ 0,1,JULDAY(4,25,2015,0,0,0)], $
                   SHOW_PLOT=0,UPDATE_PLOTS=1  ; April 17th, 2018
; PRINT, SYSTIME() + ' Plotting DATA IN MJ03E-LILY.idl'

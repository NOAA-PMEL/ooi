;
; File: RunPlotCTD7Days4MJ03B.pro
;
; Display the CTD data: {Density, Salinity & Temperature} near the station: MJ03B.
; for the last 7 Days only.
;
; Also see RunPlotCTD4MJ03B.pro for plotting the last 6 months and All data.
;
...
;.RUN ~/rsn/match.pro
;
  PRINT, SYSTIME() + ' Start running of RunPlotCTD7Days4MJ03B.pro ...'
;
...
;
  RESTORE, '~/4Chadwick/RSN/MJ03B/CTD7DaysMJ03B.rsn'
;
...
; The following steps will be done by the file: RunPlotCTD7Days4MJ03B.pro
;
  PRINT, SYSTIME() + ' Finish running of RunPlotCTD7Days4MJ03B.pro.'
;
; End of File: RunPlotCTD7Days4MJ03B.pro

...
PROCESS_RSN_FILES, /LOG_THE_LAST_FILE, $
  '/data/ooi/ftp/mj03b/','~/4Chadwick/RSN/'         ; August 22nd, 2020
; '/data/chadwick/4andy/mj03b/','~/4Chadwick/RSN/'  ; Old Directories
;
...
;
; UPDATE_NANO_DATA2FILE, 'MJ03B/3DayMJ03B-NANO.idl',   $
;   '/data/lau/4Chadwick/RSN/Apr-May2015MJ03B-NANO.Data'
;
; CHECK_NANO4ALERTS,'MJ03B/MJ03B-NANO.idl'
;
EXIT

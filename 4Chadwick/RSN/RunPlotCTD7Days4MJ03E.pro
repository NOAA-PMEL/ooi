;
; File: RunPlotCTD7Days4MJ03E.pro
;
; Display the CTD data: {Density, Salinity & Temperature} near the station: MJ03E.
; for the last 7 Days only.
;
; Also see RunPlotCTD4MJ03E.pro for plotting the last 6 months and All data.
;
...
; P = PLOT( CTD_TIME[K:N], CTD_TEMP[K:N], 'r',    DIMENSION=[800, 256],   $
  P = PLOT( CTD_TIME[ I ], CTD_TEMP[ I ], 'r',    DIMENSION=[800, 256],   $
            TITLE='MJ03E CTD Temperature data, last 7 days',   BUFFER=B,  $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',                         $
           XTITLE=T, YTITLE='$Temperature in ^{o}C$', XSTYLE=1, XMINOR=23 )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDTemp7days.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDTemp7days.png is created.'
;
...
; P = PLOT( CTD_TIME[K:N],     DENSITY[K:N], 'b', DIMENSION=[800, 256],        $
  P = PLOT( CTD_TIME[ I ],     DENSITY[ I ], 'b', DIMENSION=[800, 256],        $
            TITLE='MJ03E CTD Density data, last 7 days',   BUFFER=B,           $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',  XMINOR=23, YRANGE=[MN,MX],  $
           XTITLE=T, YTITLE='$Density: kg/m^{3}$', XSTYLE=1                    )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDDens7days.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDDens7days.png is created.'
;
...
; P = PLOT( CTD_TIME[K:N],     SALINITY[K:N],'g', DIMENSION=[800, 256],  $
  P = PLOT( CTD_TIME[ I ],     SALINITY[ I ],'g', DIMENSION=[800, 256],  $
            TITLE='MJ03E CTD Salinity data, last 7 days',   BUFFER=B,    $
           XTICKFORMAT='(C(CDI,1X,CMoA,1X,CYI))',  YRANGE=[MN,MX],       $
           XTITLE=T, YTITLE='Salinity: ppt', XMINOR=23,  XSTYLE=1        )
;
  WRITE_PNG, '~/4Chadwick/RSN/MJ03E/MJ03ECTDSal7days.png', P.CopyWindow()
  PRINT, SYSTIME() + ' MJ03E/MJ03ECTDSal7days.png is created.'
;
; The following steps will be done by the file: RunPlotCTD7Days4MJ03E.pro
;
  PRINT, SYSTIME() + ' Finish running of RunPlotCTD7Days4MJ03E.pro.'
;
; End of File: RunPlotCTD7Days4MJ03E.pro
